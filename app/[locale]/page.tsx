                ...
                <Box  sx={{ mt: 6, mb: 4}}>
                    ...
                    <Box sx={{
                        ...
                        <Typography variant={'h3'}>
                            ...
                            {skills.fr_skills.map((skill, index) => (
                        ...
                        <Paper variant="skillCard">
                            ...
                            {skills.bc_skills.map((skill, index) => (
                                <li key={index} >{skill} </li>
                            ))}
                        </Paper>
                        <Paper variant="skillCard">
                            ...
                            {skills.db_skills.map((skill, index) => (
                                <li key={index} >{skill} </li>
                            ))}
                        </Paper>
                        <Paper variant="skillCard">
                            ...
                            {skills.test_skills.map((skill, index) => (
                                <li key={index} >{skill} </li>
                            ))}
                        </Paper>
                        <Paper variant="skillCard">
                            ...
                            {skills.m_skills.map((skill, index) => (
                                <li key={index} >{skill} </li>
                            ))}
                        </Paper>
                    </Box>
